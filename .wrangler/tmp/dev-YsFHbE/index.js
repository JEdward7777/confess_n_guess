...
var ALL_QUESTIONS = [
  ...
  // --- Second batch (2026-07-20): concrete, family-safe, good lie potential. Appended,
  // not reordered, so saved usedQuestionIndexes/assignedQuestions stay valid.
  "What's the first thing I'd buy if I won the lottery?",
  "What's my most useless skill?",
  "What food will I absolutely not eat?",
  "What's the longest I've ever gone without sleep?",
  "What's the worst haircut I've ever had?",
  "What chore do I hate the most?",
  "What's my guiltiest-pleasure TV show or movie?",
  "What's the strangest thing I've ever collected?",
  "What's the most trouble I got into as a kid?",
  "What's my worst habit?",
  "What's the weirdest thing in my fridge right now?",
  "What sound do I hate the most?",
  "What's the silliest thing I've ever cried about?",
  "What did I want to be when I grew up, back when I was five?",
  "What's the most embarrassing song I secretly love?",
  "What's the farthest from home I've ever traveled?",
  "What's my signature dance move?",
  "What's the worst gift I've ever received?",
  "What's the one thing I'm always losing?",
  "What's my go-to karaoke song?",
  "What's the strangest compliment I've ever received?",
  "What's my favorite board game or card game?",
  "What's the weirdest thing I believed as a kid?",
  "What was the first concert I ever went to?",
  "What's my favorite way to spend a rainy day?",
  "What's the most useless fact I know?",
  "What's the worst injury I've ever had?",
  "What's a small thing that instantly makes my day?",
  "What's the strangest place I've ever fallen asleep?",
  "What one word would my friends use to describe me?"
];
...
// .wrangler/tmp/bundle-X3ZWK9/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-X3ZWK9/middleware-loader.entry.ts
